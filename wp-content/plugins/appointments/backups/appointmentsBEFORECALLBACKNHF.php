		...
		if ( !$this->is_worker( $user_id ) )
			...
			<script>
				...
				jQuery('.app_confirm').click( function() { 
					...
					var cancel_app_service = jQuery(this).parent('td').parent('tr').children('.service_name').text(); 
					//alert(cancel_app_status + cancel_app_service); 
					if( cancel_app_service == 'Lesson' && cancel_app_status == 'pending' ) { 
