...
<div class="input-append"/>
							...
							<input class="span3 search-query" type="text" id="search-terms" placeholder="Search by teacher, instrument, or school" name="search-terms" value="<?php echo isset( $_REQUEST['s'] ) ? esc_attr( $_REQUEST['s'] ) : ''; ?>" />
