...
<div id="activ_he">
<?php if ( bp_is_current_action( 'just-me' ) ):
echo '<h2 class="act_ti">Personal Activity</h2>';
elseif ( bp_is_current_action( 'mentions' ) ):
echo '<h2 class="act_ti">Mentions</h2>';
elseif ( bp_is_current_action( 'favorites' ) ):
echo '<h2 class="act_ti">Favorites</h2>';
elseif ( bp_is_current_action( 'friends' ) ):
echo '<h2 class="act_ti">Connections</h2>';
endif; ?>
