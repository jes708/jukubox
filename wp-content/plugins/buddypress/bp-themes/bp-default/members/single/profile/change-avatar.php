	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p id="avatar-upload">
				...
				<input type="submit" name="upload" class="btn btn-primary" id="upload" value="<?php _e( 'Upload Image', 'buddypress' ); ?>" />
				<input type="hidden" name="action" id="action" value="bp_avatar_upload" />
			</p>

			<?php if ( bp_get_user_has_avatar() ) : ?>
				<p><?php _e( "If you'd like to delete your current profile picture but not upload a new one, please use the delete picture button.", 'buddypress' ); ?></p>
				<p><a class="button edit btn btn-primary" href="<?php bp_avatar_delete_link(); ?>" title="<?php _e( 'Delete Avatar', 'buddypress' ); ?>"><?php _e( 'Delete Picture', 'buddypress' ); ?></a></p>
			<?php endif; ?>
		...
		<?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<input type="submit" name="avatar-crop-submit" class="btn btn-primary" id="avatar-crop-submit" value="<?php _e( 'Crop Image', 'buddypress' ); ?>" />
