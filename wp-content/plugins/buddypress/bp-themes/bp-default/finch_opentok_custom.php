...
<?php
// cause stay leave prompt if in this room 
// end room 
	...
	if( isset($post_newroom_id) )  { 
		$check_id = "SELECT 
				...
				FROM
					wp_juku_newrooms
				WHERE
					room_key = '" . $post_newroom_id . "'
				"; 

		$check_id_array = finch_mysql_query($check_id, "return"); 

		$check_id_id = $check_id_array[0]['ID']; 

		if( !$check_id_id ) { 
			lesson_room_error_message(); 		
		} 
		else {
			$db_session_id = $check_id_array[0]['session_id']; 
		}  
...
<script type="text/javascript">
  ...
  /*  OLD NHF HANDLERS  
    ...
    //--------------------------------------
		...
		// NHF custom subscriber edits
			var SVIDEO_WIDTH =  /*640;*/ 800; 
			var SVIDEO_HEIGHT = /*480;*/ 600; 
			// scubscriber props - replaced variables with S variables 	
		// end custom edits
		//	var subscriberProps = {width: VIDEO_WIDTH, height: VIDEO_HEIGHT};
		
			var subscriberProps = {width: SVIDEO_WIDTH, height: SVIDEO_HEIGHT};
