...
<a href="<?php echo get_home_url() . '/teachers'; ?>"><section class="f-part-divide black">
	...
	<p id="White_home_p">Our faculty consists of the world's most respected instructors from the top conservatories, performance ensembles, and other musical organizations.</p>
