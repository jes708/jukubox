		...
		<div id="footer">
			...
			<div id="foot_follow">
				<p>Follow us</p>
				<div id="foot_buttons">
				<h1 id="fb_link_button" role="button"><a href="https://www.facebook.com/JukuboxOfficial"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2013/10/FBButton.png"></a></h1>
				<h1 id="tw_link_button" role="button"><a href="https://twitter.com/JukuboxOfficial"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2013/10/TwitterButton.png"></a></h1>
                                <h1 id="yt_link_button" role="button"><a href="https://www.youtube.com/JukuboxOfficial"><img src="<?php echo get_home_url(); ?>/wp-content/uploads/2013/10/YoutubeButton.png"></a></h1>
				</div>
			</div>
			<div id="jukucopyright">
			<p>Copyright © 2013-2015 Jukubox LLC.</p>
			<br>
                ...
                <div style="overflow:hidden; width:460px; height:370px; left:260px; bottom:25px; color:white; position:relative; z-index:9999999;" id="inst_footer">
                               ...
                               <div style="float:left; margin-right:60px;" id="foot_col_2">
                                 <?php foreach( $foot_col_2 as $key => $value ): ?>
                                        ...
                                        <dt value="<?php echo $first_label; ?>"><?php echo $first_label; ?></dt>
                                                <?php endif; ?>
                                         <dd value="<?php echo $value['name']; ?>"><a href="<?php echo get_home_url() . '/teachers/?instrument=' . $value['name'] ?>"><?php echo $value['name']; ?></a></dd>						<?php $last_label = $begin_end['lasts'];
                        ...
                        <div id="foot_col_3" style="float:left; margin-right:85px;">
                                 <?php foreach( $foot_col_3 as $key => $value ): ?>
                                        ...
                                        <dt value="<?php echo $first_label; ?>"><?php echo $first_label; ?></dt>
                                                <?php endif; ?>
                                                <dd value="<?php echo $value['name']; ?>"><a href="<?php echo get_home_url() . '/teachers/?instrument=' . $value['name'] ?>"><?php echo $value['name']; ?></a></dd>
                        ...
                        <p>Browse by Style<p>
                                <?php foreach( array_slice($instruments_array, 0, 3) as $key => $value ): ?>
                                        <?php  $instrument_name = $value['name'];
                                               $first_label = $begin_end['firsts'][$instrument_name]; ?>
                                        <ul>
					<li value="<?php echo $value['name']; ?>"><a href="<?php echo get_home_url() . '/teachers/?instrument=' . $value['name'] ?>"><?php echo $value['name']; ?></a></li>
                                        <?php $last_label = $begin_end['lasts'];
                                                if(!empty( $last_label[$instrument_name] ) ) : ?>
                                        </ul>
                                                <?php endif; ?>
