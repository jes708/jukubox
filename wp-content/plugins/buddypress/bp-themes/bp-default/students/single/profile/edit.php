...
<form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
			...
			<div<?php bp_field_css_class( 'editfield' ); ?>>
				...
				<?php if ( 'datebox' == bp_get_the_profile_field_type() ) : ?>
					...
					<div class="datebox">
						...
						<select name="<?php bp_the_profile_field_input_name(); ?>_year" class="span2" id="<?php bp_the_profile_field_input_name(); ?>_year" <?php if ( bp_get_the_profile_field_is_required() ) : ?>aria-required="true"<?php endif; ?>>
	...
	<div class="submit">
		<button type="submit" name="profile-group-edit-submit" class="btn btn-primary" id="profile-group-edit-submit"><?php _e( 'Save Changes', 'buddypress' ); ?></button>
	</div>
