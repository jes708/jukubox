...
function bp_activity_delete_link() {
	...
	function bp_get_activity_delete_link() {
		...
		$link = '<a href="' . wp_nonce_url( $url, 'bp_activity_delete_link' ) . '" class="item-button bp-secondary-action ' . $class . ' confirm" rel="nofollow">' . __( '<i class="icon-large icon-remove"></i>', 'buddypress' ) . '</a>';
