		...
		switch ( $is_friend ) { // NHF EDIT - make it visible when logged in 
			case 'pending' :
				$button = array(
					...
					'link_text'         => __( '<i class="icon-remove icon-large"></i> Cancel Request', 'buddypress' ),
			...
			case 'is_friend' :
				$button = array(
					...
					'link_text'         => __( '<i class="icon-remove icon-large"></i> Cancel Friendship', 'buddypress' ),
			...
			default:
				$button = array(
					...
					'link_text'         => __( '<i class="icon-user icon-large"></i> Add Friend', 'buddypress' ),
