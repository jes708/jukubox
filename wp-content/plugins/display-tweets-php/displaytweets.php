    ...
    public function show() {
        ...
        foreach ( $tweets as $tweet ) {
            ...
            if ( has_action( 'displaytweets_tweet_template' ) ) :
                ...
                /** Print tweet */
		// NHF EDIT - put in twitter picture 
                echo "<p><img src='" . get_home_url() . "/wp-content/uploads/2013/06/twitter-bird-light-bgsResized.png' class='lit_twit_pic'  />{$this->format_tweet( $tweet->text )}<br /><small class=\"muted\">- {$posted_since}</small></p>";
