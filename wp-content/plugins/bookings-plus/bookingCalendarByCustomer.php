...
<div class="span12 well" style="padding:10px 0px" id="headerContent">
											...
											?>
						               		...
						               		?>
						                 			...
						                 			<div class="controls searchDrop">
						                 				<input type="text" class="required span12" readonly="readonly" name="uxTxtControl<?php echo $bookingFeild[$flagField]->BookingFormId;?>" id="uxTxtControl<?php echo $bookingFeild[$flagField]->BookingFormId;?>" value=""/>	
										 			</div>
						              			</div>
						              		<?php
...
<script>
	...
	function insertBooking(customerId)
	{
		...
		({
				...
				"&bookingDate="+bookingDate+"&target=insertBookingCustomer&action=getAjaxExecuted",
				url:  ajaxurl,
				success: function(data) 
				{	
					setTimeout(function() 
