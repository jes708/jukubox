...
<script type='text/javascript' src='<?php echo $url1;?>/wp-includes/js/jquery/jquery.js'></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/forms/jquery.uniform.min.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/forms/jquery.maskedinput.min.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/source/jquery.fancybox.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/tables/jquery.dataTables.min.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/forms/jquery.validate.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/bootstrap/bootstrap.min.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/bootstrap/bootstrap-bootbox.min.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/plugins/bootstrap/bootstrap-colorpicker.js"></script>
<script type='text/javascript' src="<?php echo $url;?>/js/jquery_ui_custom.js"></script>
<style type="text/css">
				...
				<div class="table-overflow" id="serviceGrid" style="display:block;">
	         	 	...
	         	 	<div id="calendarGrid" style="display:none;padding:10px;">
	         			<div class="row-fluid nested">
			         	 		...
			         	 		<div class="inlinepicker" style="width:200px;float:left"></div>
			         	 		<div id="scriptCalendar"></div>
			         	 		<input type="hidden" id="hdEmployeeId" value=""/>
			         	 		<input type="hidden" id="hdServiceId" value=""/>
			         	 	
	         	 			<div class="well" style="margin-left:10px;width:540px;float:left;">
								<?php
