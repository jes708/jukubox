...
class Pw_Login_Widget extends WP_Widget
{
	...
	public function form( $instance ) {
		...
		?>
			...
			<a href="http://superplug.in/help-us-improve-one-first-120-power-widgets-buyers-will-win-500-worth-apple-stores-gift-card/?utm_source=nice_login_widget__inSidebars_links&utm_medium=banner&utm_campaign=Nice+Login+Widget" target="_blank"><img src="<?php echo plugins_url("images/nice-login-widget.png", __FILE__) ?>" style="border: 1px #dfdfdf solid; border-radius: 4px;"></a>
...
<!--						<li><a class="sp-flipping-link" href='<?php // echo is_multisite() ? network_site_url('wp-signup.php') : '#sp-register' ; ?>'><?php // _e('Register', 'pwLogWi') ?></a></li> -->
						<li><a class="sp-not-flipping-link" href='<?php echo get_home_url() . "/register/"?>'><?php _e('Register', 'pwLogWi') ?></a></li>
					<?php endif; ?>
