...
// NHF  - set redirect always the same
$_REQUEST['redirect_to'] = get_home_url(); 
// end 
...
function login_header($title = 'Log In', $message = '', $wp_error = '') {
	...
	if ( is_multisite() ) {
		...
		$login_header_url   = __( 'http://jukubox.com/' );
		$login_header_title = __( 'Built By Musicians.  Built For You.' );
	}
